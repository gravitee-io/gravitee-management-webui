...
function applicationsNotificationsRouterConfig($stateProvider) {
  'ngInject';
  $stateProvider
    .state('portal.applications.application.notifications', {
      url: '/notifications',
    ...
    .state('portal.applications.application.notifications.notificationSetting', {
      url: '?notificationId',
    ...
    .state('portal.applications.application.notifications.alert', {
      url: '?alertId',
